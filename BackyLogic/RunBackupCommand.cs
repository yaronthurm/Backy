...
namespace BackyLogic
{
    ...
    public class RunBackupCommand: IRunBackupCommand
    {
        ...
        public void Execute()
        {
            ...
            try {
                if (BackupDirectory.FromPath(_targetForSource, _fileSystem).BackupMode != "diff")
        ...
        private IState GetLastBackedUpState()
        {
            ...
            IStateCalculator stateCalculator = new StateCalculator(_fileSystem, _targetForSource, null, _machineID.Value);
        ...
        private static string FindOrCreateTargetForSource(string source, string target, IFileSystem fs, string machineID)
        {
            ...
            if (sourceGuid == null)
            {
                ...
                BackupDirectory.CreateIniFile(sourceGuid, target, source, fs, machineID, "diff");
            }
